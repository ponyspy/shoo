$(function() {
	...
	function remove (event) {
		...
		var quotes = [
			...
			'Со скоростью света', 'За интеллект и дальше', 'Осенний торт', 'Разнообразие в отсутствии совершенства',
			'Просвещение неизбежно', 'Работать в корзину, но не впустую', 'Неоптимальное равновесие',
			'Нравится тебе пирожок?', 'Рябину рубили зорькою', 'Три конца одного света',
			'Я зубная паста', 'Сделать просто - очень сложно', 'Если в поднебесной хаос, значит все в порядке',
			'Ничего не забыли, но ничему и не научились', 'Из ничего ничего и проистекает',
			'Науки неестественные', 'Науки противоестественные', 'Полезный идиот',
	...
	$(document)
		...
		.on('click', '.item_rm.news_item', {path:'/admin/news/remove', description: 'Удалить новость?'}, remove)
